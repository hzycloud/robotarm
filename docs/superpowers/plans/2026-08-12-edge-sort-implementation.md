...
- 文档风格规范（用户明确要求，2026-08-13 追加）：Markdown 文档采用论文版式，标题后使用编号章节，少用加粗与多级标题等装饰性符号，优先平实文本与简单列表。
...
1. 安装 Windows 本地 Python 与 pytest
